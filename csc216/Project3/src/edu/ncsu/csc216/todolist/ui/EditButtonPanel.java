...
/**
 * A JPanel of buttons for the CategoryTab and TaskTab objects.
 * 
...
public class EditButtonPanel extends JPanel {
	...
	public JButton getAddButton() {
		if (null == btnAdd) {
			...
			//Sets the action command to add - this is used in CategoryTab.actionPerformed.
	...
	public JButton getSaveButton() {
		if (null == btnSave) {
			...
			//Sets the action command to save - this is used in CategoryTab.actionPerformed.
	...
	public JButton getCancelButton() {
		if (null == btnCancel) {
			...
			//Sets the action command to cancel - this is used in CategoryTab.actionPerformed.
