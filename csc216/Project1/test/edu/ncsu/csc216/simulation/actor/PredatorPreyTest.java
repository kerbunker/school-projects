...
/**
 * Test for the PredatorPrey class
 * @author Kbunker
 *
 */
public class PredatorPreyTest {
	...
	public void testGetColor() {
		...
		Animal a = new PredatorPrey('A');
		Configs.setToDefaults();
		assertEquals(Color.ORANGE, a.getColor());
	}
	...
	public void testAct() {
		...
		a1 = new PredatorPrey('A');
		ec.add(a1, l1);
		Animal a2 = new PurePrey('B');
		ec.add(a2, l2);
		a2.enable();
		a1.enable();
